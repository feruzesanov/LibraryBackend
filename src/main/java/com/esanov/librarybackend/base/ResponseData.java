...
public class ResponseData<T> {
    ...
    public static ResponseEntity<ResponseData<ResponseMessage>> success200(String message) {
        return ResponseEntity.ok(new ResponseData<>(new ResponseMessage(message)));
    }
    ...
    public static ResponseEntity<ResponseData<ResponseMessage>> success201(String message) {
        return new ResponseEntity<>(new ResponseData<>(new ResponseMessage(message)), HttpStatus.CREATED);
    }
    ...
    public static ResponseEntity<ResponseData<ResponseMessage>> success202(String message) {
        return new ResponseEntity<>(new ResponseData<>(new ResponseMessage(message)), HttpStatus.ACCEPTED);
    }
    ...
    public static <T> ResponseEntity<ResponseData<T>> notAuth(String errorMessage) {
        return new ResponseEntity<>(new ResponseData<>(errorMessage), HttpStatus.UNAUTHORIZED);
    }

    public static <T> ResponseEntity<ResponseData<T>> notAccess(String errorMessage) {
        return new ResponseEntity<>(new ResponseData<>(errorMessage), HttpStatus.FORBIDDEN);
    }
